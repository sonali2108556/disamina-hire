      ...
      <main className="flex-grow">
        <section className="py-16 md:py-24">
          <div className="container mx-auto px-4 md:px-6">
            ...
            <p className="mb-4">
              The website located at <span className="font-bold">www.disamina.ai</span>
              [hereinafter “website”] is an online software solution belonging to
              Disamina Corp Pvt. Ltd. [hereinafter “Disamina” or “Company”].
            </p>
            ...
            <p className="mb-4">
              ...
              BEING COMPLIANT WITH THESE TERMS and you represent that you have the
              authority and capacity to enter into these Terms. IF YOU DISAGREE WITH
            ...
            <p className="mb-4">
              We provide online assessment software as a SaaS where you can conduct
              online exams. You may create your own exam or purchase our pre-built exams
              (all these collectively known as “Services”). You may use the Services for
              your personal and business use or for internal business purposes in the
              organization that you represent. You may use our Services using any Internet
              browser supported by the Services. You can create and edit content with your
            ...
            <ul className="list-disc ml-6 mb-4">
              <li>
                You need to create a user account by providing all required information in order to use the Services of Website. If you represent an organization and wanted to use the Services internally within your organisation, we recommend that you, and all other users from your organization, create user accounts by using your corporate email id. You agree to a) provide true, accurate, current and complete information about yourself as prompted by the signup process; and b) maintain and promptly update the information provided during sign up to keep it true, accurate, current, and complete. In case of any information that is untrue, inaccurate, outdated, or incomplete, or if Disamina has reasonable grounds to suspect that such information is untrue, inaccurate, outdated, or incomplete, Disamina may terminate your account and refuse use of Disamina Services.
              </li>
              <li>
            ...
            <ul className="list-disc ml-6 mb-4">
              ...
              <li>
                You agree to indemnify and hold Company and its officers, employees, and agents harmless, including costs and attorneys’ fees, from any claim or demand made by any third-party due to or arising out of (a) your use of the Site, (b) your violation of these Terms, (c) your violation of applicable laws or regulations or (d) your User Content.  Company reserves the right to assume the exclusive defense and control of any matter for which you are required to indemnify us, and you agree to cooperate with our defense of these claims.  You agree not to settle any matter without the prior written consent of Company.  The company will use reasonable efforts to notify you of any such claim, action or proceeding upon becoming aware of it.
            ...
            <ul className="list-disc ml-6 mb-4">
              <li>
                Third-Party Links & Ads. The Site may contain links to third-party websites and services, and/or display advertisements for third-parties.  Such Third-Party Links u0026amp; Ads are not under the control of Company, and Company is not responsible for any Third-Party Links u0026amp; Ads.  The company provides access to these Third-Party Links u0026amp; Ads only as a convenience to you and does not review, approve, monitor, endorse, warrant, or make any representations with respect to Third-Party Links u0026amp; Ads.  You use all Third-Party Links u0026amp; Ads at your own risk and should apply a suitable level of caution and discretion in doing so. When you click on any of the Third-Party Links u0026amp; Ads, the applicable third party’s terms and policies apply, including the third party’s privacy and data gathering practices.
              </li>
              <li>
            ...
            <ul className="list-disc ml-6 mb-4">
              <li>These Terms are subject to occasional revision, and if we make any substantial changes, we may notify you by sending you an e-mail to the last e-mail address you provided to us and/or by prominently posting notice of the changes on our Site.  You are responsible for providing us with your most current e-mail address.  In the event that the last e-mail address that you have provided us is not valid our dispatch of the e-mail containing such notice will nonetheless constitute effective notice of the changes described in the notice.  Any changes to these Terms will be effective upon the earliest of fifteen (15) calendar days following our dispatch of an e-mail notice to you or fifteen (15) calendar days following our posting of notice of the changes on our Site.  These changes will be effective immediately for new users of our Site.  Continued use of our Site following notice of such changes shall indicate your acknowledgment of such changes and agreement to be bound by the terms and conditions of such changes.</li>
              <li>Electronic Communications: The communications between you and Company use electronic means, whether you use the Site or send us emails, or whether Company posts notices on the Site or communicates with you via email. For contractual purposes, you (a) consent to receive communications from Company in an electronic form; and (b) agree that all terms and conditions, agreements, notices, disclosures, and other communications that Company provides to you electronically satisfy any legal obligation that such communications would satisfy if it were in a hard copywriting.</li>
            ...
            <ul className="list-disc ml-6">
              <li>No cancellation and refund shall be provided in any case if purchase of subscription or exam is made. If the Customer has terminated the contract, the fees for the partial month will not be refunded.</li>
            </ul>
            ...
            <ul className="list-disc ml-6">
              <li>In case of a failed transaction, any amount deducted from your account will be refunded within 12-15 business days.</li>
            </ul>
            <p className="my-4 font-bold">
              Additional Considerations
            </p>
            <ul className="list-disc ml-6">
              <li>Unused Credits: Any unused exam credits from a canceled subscription will not be refunded but may be used to continue the use of Disamina services till credits become Zero.</li>
              <li>Force Majeure: We reserve the right to suspend or terminate your subscription in case of unforeseen circumstances beyond our control, such as natural disasters or cyberattacks. In such cases, we will make reasonable efforts to provide advance notice and alternative solutions.</li>
            </ul>
            <p className="my-4 font-bold">If you have any questions or concerns regarding this agreement, please write us at support@disamina.ai.</p>
            <p className="text-gray-500 mt-6">Last updated on March 12, 2025</p>
          </div>
        </section>
      </main>
      <Footer />
