        ...
        <section className="py-16 md:py-24">
          <div className="container mx-auto px-4 md:px-6">
              ...
              <ol className="list-disc ml-6 mb-4 ">
                ...
                <li>
                  ...
                  <ul className="list-disc list-inside mt-2">
                    ...
                    <li>
                      <strong>Contact Form:</strong> Visit our <Link href="/privacy" className="text-indigo-600 hover:underline">Privacy Policy</Link> page and use the contact form provided for data deletion requests.
                    </li>
            ...
            <div className="bg-gray-50 py-3 px-4 sm:px-6 flex justify-end">
              <Link href="/privacy" className="text-indigo-600 hover:underline">Read our full Privacy Policy</Link>
            </div>
          </div>
        </section>
      </main>
