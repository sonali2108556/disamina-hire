          ...
          <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
              ...
              <Card className="card-hover">
                ...
                <CardContent>
                  <p>Paste any job description and let AI analyze the key requirements, showing you exactly what skills to emphasize in your application.</p>
                </CardContent>
              ...
              <Card className="card-hover">
                ...
                <CardContent>
                  <p>AI analyzes your resume against the job description and provide detailed feedback to ensure maximum matching score with ATS systems.</p>
                </CardContent>
